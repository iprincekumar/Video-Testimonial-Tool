...
app.post("/upload", upload.single("video"), async (req, res) => {
  ...
  try {
    ...
    const auth = new google.auth.GoogleAuth({
      keyFile: "video-testimonial-tool-435208-d57a25b7af3d.json", // Path to the service account key file
    ...
    const fileMetadata = {
      ...
      parents: ["1cel6IdmXSQ7PGTpBkeVE6rnk5IVKRxLZ"], // Parent folder ID in Google Drive
    };
    const media = {
